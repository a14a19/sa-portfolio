      ...
      <>
         {props.type === "EXPERIENCE" && (
            <aside className="w-full h-min pt-1 border border-[#d8d8d830] bg-[#1e1e1e] rounded-xl overflow-hidden">
               ...
               <div className="h-[33rem] overflow-y-auto px-3">
                  {experience &&
         ...
         {props.type === "KINDWORDS" && (
            <aside className="w-full h-min pt-1 border border-[#d8d8d830] bg-[#1e1e1e] rounded-xl overflow-hidden">
               ...
               <div className="mx-2 border-b-2 mt-1 border-[#d8d8d830]"></div>
               <div className="h-[6.6rem] overflow-y-auto px-3 pt-3 flex flex-col gap-3 text-xs">
                  <p>
         ...
         {props.type === "YEARSPROCTAS" && (
            <aside className="flex w-full gap-5 h-min">
         ...
         {props.type === "EDUCATION" && (
            <aside className="w-full h-min pt-1 border border-[#d8d8d830] bg-[#1e1e1e] rounded-xl overflow-hidden">
               ...
               <div className="mx-2 border-b-2 mt-1 border-[#d8d8d830]"></div>
               <div className="h-[19.1rem] overflow-y-auto px-3 pt-3 flex flex-col gap-3 ">
                  {education &&
